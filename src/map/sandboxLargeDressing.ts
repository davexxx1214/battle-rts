...
/** Dense tree belts frame the two lower flank fields without turning them
 * into walls; all placements remain presentation-only and walkable. */
const SANDBOX_LARGE_VERDANT_FLANK_FOREST_CELLS: readonly HexCoordinate[] =
  freezeCoordinates([
    { q: -16, r: 9 },
    { q: -17, r: 10 },
    { q: -17, r: 11 },
...
export const SANDBOX_LARGE_FLANK_FOREST_CELLS: readonly HexCoordinate[] =
  freezeCoordinates([
    ...SANDBOX_LARGE_VERDANT_FLANK_FOREST_CELLS,
    ...SANDBOX_LARGE_VERDANT_FLANK_FOREST_CELLS.map(({ q, r }) => ({
      q: q === 0 ? 0 : -q,
      r: -r,
    })),
  ]);
...
export const SANDBOX_LARGE_WILDLIFE: readonly SandboxWildlifePlacement[] = Object.freeze([
  ...
  wildlife("sandbox-river-deer-north", "deer", { q: 8, r: 8 }, { x: -0.2, z: 0.12 }, 0.86, -0.7, "Idle"),
